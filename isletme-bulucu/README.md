...
4. Varsayılan kategori: Kuaför & Güzellik (hızlı); “Tümü” daha yavaş
5. Website var/yok etiketi
6. Açık / kapalı (OSM `opening_hours`)
7. Potansiyel müşteri puanı (kural tabanlı, AI yok)
8. Filtreler: kategori, mesafe, website, açık/kapalı, sıralama
9. 15 dk localStorage önbellek + önce 1 km, sonra tam yarıçap
10. İşletme kartları + detay paneli
11. WhatsApp linki (telefon varsa)
12. CSV export
13. Responsive SaaS layout (desktop: filtre | harita | liste)
